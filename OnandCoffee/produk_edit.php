   ...
   <div class="sidebar-footer hidden-small">
      ...
      <section class="base">
        ...
        <div>
          ...
          <select class="custom-select" name="jenisProduk" id="jenisProduk">
              <?php if($data['jenisProduk'] == 'Biji Kopi') { ?>
                <option value="Biji Kopi" selected>Biji Kopi</option>
                <option value="Minuman Panas">Minuman Panas</option>
                <option value="Minuman Panas/Dingin" >Minuman Panas/Dingin</option>
              <?php } else if ($data['jenisProduk'] == 'Minuman Panas') { ?>
                <option value="Biji Kopi">Biji Kopi</option>
                <option value="Minuman Panas" selected>Minuman Panas</option>
                <option value="Minuman Panas/Dingin" >Minuman Panas/Dingin</option>
              <?php } else if ($data['jenisProduk'] = 'Minuman Panas/Dingin') { ?>
                <option value="Biji Kopi">Biji Kopi</option>
                <option value="Minuman Panas">Minuman Panas</option>
                <option value="Minuman Panas/Dingin" selected >Minuman Panas/Dingin</option>
              <?php } ;?>
          </select>
        </div>
        <div>
          <label>Harga Produk</label>
          <?php if($data['hargaProduk']){?>
            <input type="text" name="hargaProduk" value="<?php echo $data['hargaProduk']; ?>" />
          <?php } else { ?>
            <input type="text" name="hargaProduk" placeholder="20K/22K" />
          <?php } ?>
        </div>
        <div>
        ...
        <div class="d-flex justify-content-end">
         ...
         <a class="perubahan-produk" href="index.php?page=tampil_produk">Batal</a>
        </div>
        </section>
      </form>
