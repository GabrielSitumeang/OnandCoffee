        ...
        <section class="base">
            ...
            <div>
                ...
                <select class="custom-select" name="hariOperasi" id="hariOperasi" required>
                    <option value="">---</option>
                    <option value="Senin" <?php if($data['hariOperasi']=="Senin"){echo "selected";} ?> >Senin</option>
                    <option value="Selasa" <?php if($data['hariOperasi']=="Selasa"){echo "selected";} ?> >Selasa</option>
                    <option value="Rabu" <?php if($data['hariOperasi']=="Rabu"){echo "selected";} ?> >Rabu</option>
                    <option value="Kamis" <?php if($data['hariOperasi']=="Kamis"){echo "selected";} ?> >Kamis</option>
                    <option value="Jumat" <?php if($data['hariOperasi']=="Jumat"){echo "selected";} ?> >Jumat</option>
                    <option value="Sabtu" <?php if($data['hariOperasi']=="Sabtu"){echo "selected";} ?> >Sabtu</option>
                    <option value="Minggu" <?php if($data['hariOperasi']=="Minggu"){echo "selected";} ?> >Minggu</option>
                </select>
            </div>
            <div>
                <label>Jam Buka</label>
                <input step="2" type="time" id="myTime" name="jamBuka" value="<?php echo $data['jamBuka']; ?>" />
            </div>
            <div>
                <label>Jam Tutup</label>
                <input step="2" type="time" id="myTime" name="jamTutup" value="<?php echo $data['jamTutup']; ?>" />
            </div>
            <div class="d-flex justify-content-end">
                <button class="perubahan-produk" type="submit">Simpan Perubahan</button>
                <a class="perubahan-produk" href="index.php?page=tampil_jamoperasi">Batal</a>
            </div>
            </section>
        </form>
      <?php
