   ...
   <div class="sidebar-footer hidden-small">
        ...
        <section class="base">
          ...
          <div>
            ...
            <input type="text" id="judulcerita" name="judulcerita" value="<?php echo $data['judulcerita']; ?>" autofocus="" required="" />
          </div>
          <div>
            <label for="deskripsicerita">Deskripsi</label>
            <textarea maxlength="700" class="form-control" id="deskripsicerita" rows="5" name="deskripsicerita" required><?php echo $data['deskripsicerita']; ?></textarea>
          </div>
          <div>
            <label>Gambar Cerita</label>
            <?php if( $data['gambarcerita'] ) :?>
          ...
          <a class="perubahan-produk" href="index.php?page=tampil_cerita">Batal</a>
          </div>
          </section>
        </form>
